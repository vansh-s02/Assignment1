...
fn main() {
    ...
    let emp_path = matches.get_one::<String>("EMP_FILE").expect("Error in Employee File Path");
    let dept_path = matches.get_one::<String>("DEPT_FILE").expect("Error in Department File Path");
    let salary_path = matches.get_one::<String>("SAL_FILE").expect("Error in Salary File Path");
    let leave_path = matches.get_one::<String>("LEAVE_FILE").expect("Error in Leave File Path");
    let output_path = matches.get_one::<String>("OUTPUT_FILE").expect("Error in Output File Path");
